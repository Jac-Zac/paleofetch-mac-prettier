#define CONFIG                                                                           \
  {/* name            function                 cached  */                                \
   ...
   SPACER{" \033[33m\033[0m    ", get_machine, true},                              \
   ...
   SPACER{"", print_software, false},                                                    \
   SPACER{" \033[33m\033[0m    ", get_complete_os, true},                          \
   {" \033[33m\033[0m    ", get_kernel, true},                                     \
   {" \033[33m\033[0m    ", get_ip, false},                                        \
   {" \033[33m\033[0m    ", get_terminal, false},                                  \
   {" \033[33m󰞌\033[0m    ", get_uptime, false},                                   \
   SPACER{"", print_end_info, false},                                                    \
   {"", get_colors_dots,                                                                 \
    false}, /* { "",             get_colors1,              true  }, \ */ /* {            \
                                                                            "",          \
                                                                            get_colors2, \
                                                                            true         \
                                                                            },           \
